...
public class OrientacaoNorteTest {
	
	private OrientacaoNorte orientacao;
	
	@Before
	public void preparaTeste() {
		this.orientacao = new OrientacaoNorte();
	}
	
	@Test
	public void verificaSentido() {
		assertThat(orientacao.getSentido(), is(Sentido.NORTH));
	}

	@Test
	public void verificaOrientacaoAposRotacaoEsquerda() {
		assertThat(orientacao.getOrientacaoAposComando(Comando.L), is(instanceOf(OrientacaoOeste.class)));
	}
	
	@Test
	public void verificaOrientacaoAposRotacaoDireita() {
		assertThat(orientacao.getOrientacaoAposComando(Comando.R), is(instanceOf(OrientacaoLeste.class)));
	}
