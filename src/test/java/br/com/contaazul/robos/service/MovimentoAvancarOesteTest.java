...
public class MovimentoAvancarOesteTest {
	...
	public void preparar() {
		movimento = new MovimentoAvancarOeste();
	}
			
	@Test
	public void verificaPosicaoEsperadaAposMovimentoAvanco() {
		
		Posicao posicaoInicial = new PosicaoBuilder().comCoordenadas(2, 0).comOrientacao(new OrientacaoOeste()).get();
		...
		Posicao posicaoEsperada = new PosicaoBuilder().comCoordenadas(0, 0).comOrientacao(new OrientacaoOeste()).get();
